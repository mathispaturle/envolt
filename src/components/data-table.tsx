  ...
  return (
    <DropdownMenu>
      ...
      <DropdownMenuContent align="end" className="w-32">
        <DropdownMenuItem onClick={() => router.push(`/vaults/${id}`)}>View</DropdownMenuItem>
        <DropdownMenuSeparator />
...
const columns: ColumnDef<Vault>[] = [
  ...
  },
  {
    ...
    cell: ({ row }) => {
      ...
      if (raw instanceof Date) {
        ...
        date = raw.toDate().toLocaleDateString("en-US", { month: "short", day: "numeric" });
      } else {
        date = "-";
      }
  ...
  },
  {
    ...
    header: () => <div className="w-full text-right">Creation date</div>,
    cell: ({ row }) => {
...
export function DataTable({ data: initialData }: { data: Vault[] }) {
